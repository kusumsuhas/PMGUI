...
public class DimsGui{
	...
	XSSFSheet worksheet;
	XSSFRow row;
	static final Logger LOGGER = Logger.getLogger(DimsGui.class);

	public DimsGui(WebDriver driver)
	{
		this.driver=driver;
	}
 ...
 */
		...
		driver.findElement(By.xpath(driverScript.objRepository("dimfact",file))).clear();
