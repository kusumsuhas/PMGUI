...
public class VDWgtBrkRates {
	...
	public VDWgtBrkRates(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	public void weightBrkRates() throws InterruptedException, IOException{
...
//					Thread.sleep(8000);
//					}catch(Exception e){
//						LOGGER.info("Already clicked on save and close");
//					}//save and close
				Thread.sleep(5000);
...
// GUI test case ends here
		...
		driver.findElement(By.xpath(driverScript.objRepository("WgtBrkRates",file))).click();
		Thread.sleep(10000);
...
//[9]M_PRC_FXFR_PricingMaintenance_WeightBreakRates_WeightBreak_RatesEffectiveDates
		...
		AAC.selectByValue(arbitraryCharges);
		...
		driver.findElement(By.xpath(driverScript.objRepository("AdjPercentage",file))).sendKeys(adjustment_Percentage);
		...
		incDec.selectByValue(increase_Decrease);
		Thread.sleep(2000);
		...
		EC.selectByValue(exceptionClass_All);
...
//[10]M_PRC_FXFR_PricingMaintenance_WeightBreakRates
		...
		driver.findElement(By.xpath(driverScript.objRepository("MaxCharge",file))).sendKeys(maximumCharge);
		...
		driver.findElement(By.xpath(driverScript.objRepository("RatePerCubicFoot",file))).sendKeys(rateperCubicFoot);
		...
		try{
			...
			LOGGER.error("Pricing change exists for the CENIs selected");
		}

		try{
			driver.findElement(By.xpath(driverScript.objRepository("Overlay",file))).click();
		}catch(Exception e){	
			LOGGER.error("Overlay button doesn't exist");
		}
